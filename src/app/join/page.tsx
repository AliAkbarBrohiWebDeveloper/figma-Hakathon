...
<input type="email"  placeholder="Email address" required className="border-b-2 border-2 w-96 mt-3"/>
<br />
<input type="password"  placeholder="Password" required className="border-2 w-96 mt-3"/>

<br />
<input type="email"  placeholder="First Name" required className="border-b-2 border-2 w-96 mt-3"/>
<br />
<input type="password"  placeholder="Last Name" required className="border-2 w-96 mt-3"/>

<br />
<input type="password"  placeholder="Date of Birth" required className="border-2 w-96 mt-3"/>
