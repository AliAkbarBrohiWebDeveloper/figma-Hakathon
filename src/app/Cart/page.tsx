...
// import { CartItem, CartItem1 } from "../types/interface";
...
//         <h1 className="text-5xl font-semibold text-gray-900 mb-6">Your Cart</h1>
...
//           <Image src={"/shoping.avif"} alt="cart Shoping image" height={500} width={500} className=""/>
//           </div>
//         ) : (
//           <div className="space-y-6">
//             {cartItems.map((item:CartItem1) => (
//               <div key={item.id} className="flex items-center justify-between p-4 border rounded-lg shadow-sm">
//                 <div className="flex items-center gap-x-4">
//                   <Image src={urlFor(item.image).url()}  alt={item.name} height={40} width={40} className="w-20 h-20 object-cover rounded-md" />
//                   <div>
...
//                 className="w-full py-3 px-6 bg-blue-600 text-white font-semibold rounded-md shadow-md hover:bg-blue-700 transition duration-300 ease-in-out"
//               >
//                 Proceed to Checkout
//               </button>
//               </Link>
