...
//   const totalPrice = cartItems.reduce((total: any, item: any) => total + item.price * item.quantity, 0).toFixed(2);
...
//                       <Image src={item.image} alt={item.name} height={100} width={100} className="object-cover rounded-md" />
//                       <div>
...
//               <div className='flex justify-between items-center text-xl font-semibold mt-8'>
...
// import { CartItem1 } from '../types/interface';
...
//           _ref: item._id,
//         })),
//         totalPrice: cartItems.reduce((total: number, item:CartItem) => total + item.price * item.quantity, 0),
//         orderStatus: 'pending',
//       });
...
//   const totalPrice = cartItems.reduce((total:number, item: CartItem) => total + item.price * item.quantity, 0).toFixed(2);
...
//                   <div className='text-center mt-9'>
//                     <button type="submit" className='px-16 py-2 rounded-sm border-2'>Continue</button>
//                   </div>
//                 </div>
//               </form>
//             </div>
